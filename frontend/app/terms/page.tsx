    ...
    <div className="relative min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
          ...
          and it is not affiliated with NoBroker, OLX, Housing.com, or any other third-party service referenced below.
        </div>
        ...
        <div className="divide-y divide-slate-200">
          ...
          <Section title="2. What RentRadar does">
            <p>
              ...
              third-party sources (including NoBroker, OLX, Housing.com, Google News, and Hacker News), and
              uses a large language model (gpt-oss-120b via Groq) to synthesise that information into a summarised
          ...
          <Section title="3. No guarantee of accuracy">
            <p>
              ...
              Service are best-effort estimates generated from scraped snippets and community sentiment (Hacker
              News, news coverage). They are not verified against the actual property, landlord, or listing
